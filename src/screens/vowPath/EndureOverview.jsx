...
const DAY_ART = { 1: 'sunrise', 2: 'piles', 3: 'roots', 4: 'fork', 5: 'scales', 6: 'columns', 7: 'candle', 8: 'drift', 9: 'lantern', 10: 'waymark', 11: 'sorter', 12: 'coins', 13: 'speech', 14: 'candle', 15: 'journal', 16: 'eye', 17: 'sorter', 18: 'body', 19: 'home', 20: 'portrait', 21: 'seal' }
const PHASE_ART = { phase_1: 'sunrise', phase_2: 'drift', phase_3: 'piles' }
...
export default function EndureOverview() {
  ...
  const heroUrl = useStageBackground('endure')
  ...
  const handleDayTap = (dayNum) => {
    ...
    navigate(`/app/vow-path/endure/day/${dayNum}`)
  }
  ...
  const saveCheckin = async () => {
    ...
    const payload = {
      ...
      archetype: ENDURE_PRACTICES[activeDay.day]?.archetype || null,
      practice_title: ENDURE_PRACTICES[activeDay.day]?.title || null,
      did_it: draft.didIt,
      ...
      <div style={styles.phone}>
        ...
        <div style={styles.heroWrap}>
          ...
          <div style={styles.heroNav}>
            ...
            <button onClick={() => navigate('/app/library/endure')} style={styles.pillBtn}>Library</button>
          </div>
        </div>
        ...
        {activeDay && (
          <div style={styles.sheetOverlay} onClick={() => setActiveDay(null)}>
            <div style={styles.sheet} onClick={(e) => e.stopPropagation()}>
              ...
              <p style={styles.sheetTitle}>{ENDURE_PRACTICES[activeDay.day]?.title}</p>

...
export const BUILD_DAYS = [
  ...
  // ===================================================================
  {
    day: 1,
    dailyActivities: [
      { day: 1, glyph: 'cup', title: `Make a warm drink, slowly`, body: `Make something warm to drink and have it with nothing else going on — no phone, no screen. Notice the warmth, the smell, the first sip. Stay with it until it's gone. Letting yourself enjoy one small thing fully is the whole point.` },
      { day: 2, glyph: 'walk', title: `Go for a slow walk`, body: `Walk for ten minutes with nowhere to be and no podcast. Notice your feet, your breath, the air on your skin. When your mind jumps to your to-do list, come back to your body. A simple walk is an easy good feeling to get back.` },
      { day: 3, glyph: 'music', title: `Listen to one song`, body: `Play one song you used to love — properly, not in the background. Sit, close your eyes, and just listen all the way through. See if anything stirs in you, even a little. Music is often the first place good feelings come back.` },
      { day: 4, glyph: 'plant', title: `Make something with your hands`, body: `Spend fifteen minutes making, fixing, or tending something — cook slowly, draw, repair, garden. Not to finish it; just to do it. Doing something with your hands, with full attention, is a simple way to feel a small, real bit of satisfaction.` },
      { day: 5, glyph: 'sun', title: `Get ten minutes outside`, body: `Go outside for ten minutes and really look at one living thing — a tree, a bird, the changing sky. No phone in your hand. Just let your eyes rest on it. A bit of time outside quietly makes everyday things feel better.` },
      { day: 6, glyph: 'tether', title: `Have one real moment with someone`, body: `Have one small, unhurried moment with another person today — a proper hello with a neighbour, a few minutes with someone at home, phone face-down. Not a task, not a text. A little real connection lifts a flat day more than you'd expect.` },
      { day: 7, glyph: 'spark', title: `Plan something to look forward to`, body: `Before bed, plan one small good thing for tomorrow and let yourself look forward to it — a coffee out, a walk, a call. Having something to look forward to is a simple pleasure the substance took over. Give it something ordinary to point at tonight.` },
    ],
    offlinePractice: {
      id: 'w1',
      archetype: 'watch',

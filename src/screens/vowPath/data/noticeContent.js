...
export const NOTICE_V2_DAYS = [
  ...
  // ===================================================================
  {
    ...
    practice: {
      ...
      body: [
        `Today you named the lines you said you\u2019d never cross \u2014 and saw that some are already behind you. The work now isn\u2019t to feel bad about that. It\u2019s to start seeing the next one coming before it becomes another line crossed in the dark.`,
        `So between now and tomorrow, just stay a little awake to it. The extra one. The earlier start. The small rule quietly bent, the promise rounded down. You don\u2019t have to stop yourself \u2014 that isn\u2019t the task today. You only have to notice, once, in the moment it\u2019s happening: there it is.`,
        `That\u2019s the whole practice. A line you can watch yourself cross has far less hold over you than one you cross half-asleep. Catching it as it happens is how it slowly stops being automatic.`,
      ],
...
That's worth knowing.`,
  ...
  // ===================================================================
  {
    ...
    practice: {
      ...
      body: [
        `You mapped how far the pattern has travelled from where it began \u2014 how the thing that started small has quietly kept moving its own goalposts. Today is about catching that drift in one ordinary, concrete detail.`,
        `Sometime before tomorrow, pick a single thing \u2014 the amount, the time of day you reach for it, the reason you give yourself \u2014 and remember honestly what it was a year or two ago. Not the dramatic version. The plain one. Then let yourself sit with the gap between then and now for a moment.`,
        `Don\u2019t turn it into a verdict on yourself. Drift isn\u2019t a moral failing; it\u2019s simply what these patterns do when no one is watching them. Letting yourself actually see how far it has carried you is what makes it possible to steer at all.`,
      ],
      button: `I\u2019ll carry this`,
    },
    openings: {
...
You'll read the ladder once, then place yourself at each point in time. Most people aren't surprised by where they are today — they already know that. They're surprised by the line that connects the dots: how far it has moved, and which way.`
  ...
  // ===================================================================
  {
    ...
    practice: {
      ...
      body: [
        `Today you wrote down what the people around you have quietly been carrying while you\u2019ve been using \u2014 the things they\u2019ve done, stopped doing, stopped asking for. Between now and tomorrow, turn that from a list into something you actually see.`,
        `Pick one person from it. Just one. And sometime today, watch them the way the ledger asked you to \u2014 what they ask of you, what they\u2019ve gone quiet about, how they hold themselves when they\u2019re near you. You don\u2019t have to apologise, explain, or fix a single thing. Saying nothing is completely fine.`,
        `Today is only for seeing them clearly, once, without the haze in the way. That clear look is its own kind of honesty \u2014 and it tends to stay with you far longer than any promise you could make right now.`,
      ],
      button: `I\u2019ll carry this`,
    },
    openings: {
...
It has been happening in the small things — and now it is written down where you can see it.`,
  ...
  // ===================================================================
  {
    ...
    practice: {
      ...
      body: [
        `You listed the things your use has quietly cost you \u2014 the hobbies, the plans, the easy mornings, the small versions of yourself you stopped making time for. On paper they can feel abstract. Today is about meeting one of them in real life.`,
        `Sometime before tomorrow, catch one of those set-down things as it actually passes \u2014 the walk you\u2019d have taken, the friend you\u2019d have called, the hour the evening quietly swallowed. Notice the shape of the thing you put down, in the moment you\u2019d otherwise have had it.`,
        `Not to pile on regret \u2014 that helps no one. Just to turn one line on the ledger into something real and specific you can see and feel. The losses we can actually picture are the ones that start to matter enough to move us.`,
      ],
      button: `I\u2019ll carry this`,
    },
    openings: {

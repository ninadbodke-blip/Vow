...
const S = {
  ...
  opt: { textAlign: 'left', padding: '12px 14px', borderRadius: '11px', border: '0.5px solid #E0D5C2', background: '#FDFBF6', color: '#3A2D1E', fontSize: '14.5px', fontFamily: 'Georgia, serif', cursor: 'pointer', lineHeight: 1.45, width: '100%' },

...
const DAY_ART = { 1: 'calendar', 2: 'home', 3: 'people', 4: 'roots', 5: 'columns', 6: 'anchor', 7: 'speech', 8: 'seal', 9: 'people', 10: 'candle' }
const PHASE_ART = { foundation: 'home', infrastructure: 'anchor', conversation_and_vow: 'seal', threshold: 'doors' }
...
export default function CommitOverview() {
  ...
  const heroUrl = useStageBackground('commit')

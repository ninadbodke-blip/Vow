...
export default function BuildOverview() {
  ...
  const summarySubtitle = (() => {
    if (totalCompleted === 0) return 'Begin with Week 1.'
    if (totalCompleted === BUILD_TOTAL_DAYS) return 'Build is complete.'
    if (currentWeek > BUILD_TOTAL_DAYS) return 'Integration time — no new entries.'
    return `Week ${currentWeek} is current.`
  })()
      ...
      <div style={styles.phone}>
        ...
        <div style={styles.summaryCard}>
          ...
          <p style={styles.summaryNumbers}>
            ...
            <span style={styles.summaryTotal}>{BUILD_TOTAL_DAYS}</span>
          </p>
          <p style={styles.summarySubtitle}>{summarySubtitle}</p>

          <div style={styles.progressBar}>
            <div
              style={{
                ...styles.progressFill,
                width: `${(totalCompleted / BUILD_TOTAL_DAYS) * 100}%`,
              }}
            ></div>
          </div>
        </div>
                    ...
                    >
                      ...
                      <div style={styles.dayStatus}>
                        ...
                        {status === STATUS.CURRENT && (
                          <div style={styles.statusCurrent}>This week</div>
                        )}
...
const styles = {
  ...
  statusCurrent: {
    fontSize: '9px', fontWeight: 500, color: '#FAF7F1',
